...
static struct MockAdcModelInstance
{
  ...
  int AdModel_DoNothingExceptTestPointers_IgnoreBool;
  ...
  int AdcModel_DoNothingExceptReturnASpecialType_IgnoreBool;
...
void MockAdcModel_Verify(void)
{
  ...
  if (Mock.AdcModel_DoGetSample_IgnoreBool)
    Mock.AdcModel_DoGetSample_CallInstance = CMOCK_GUTS_NONE;
  UNITY_SET_DETAIL(CMockString_AdcModel_DoGetSample);
  UNITY_TEST_ASSERT(CMOCK_GUTS_NONE == Mock.AdcModel_DoGetSample_CallInstance, cmock_line, CMockStringCalledLess);
  if (Mock.AdcModel_ProcessInput_IgnoreBool)
    Mock.AdcModel_ProcessInput_CallInstance = CMOCK_GUTS_NONE;
  UNITY_SET_DETAIL(CMockString_AdcModel_ProcessInput);
  UNITY_TEST_ASSERT(CMOCK_GUTS_NONE == Mock.AdcModel_ProcessInput_CallInstance, cmock_line, CMockStringCalledLess);
  if (Mock.AdcModel_DoNothingExceptTestASpecialType_IgnoreBool)
    Mock.AdcModel_DoNothingExceptTestASpecialType_CallInstance = CMOCK_GUTS_NONE;
  UNITY_SET_DETAIL(CMockString_AdcModel_DoNothingExceptTestASpecialType);
  UNITY_TEST_ASSERT(CMOCK_GUTS_NONE == Mock.AdcModel_DoNothingExceptTestASpecialType_CallInstance, cmock_line, CMockStringCalledLess);
  if (Mock.AdModel_DoNothingExceptTestPointers_IgnoreBool)
    Mock.AdModel_DoNothingExceptTestPointers_CallInstance = CMOCK_GUTS_NONE;
  UNITY_SET_DETAIL(CMockString_AdModel_DoNothingExceptTestPointers);
  UNITY_TEST_ASSERT(CMOCK_GUTS_NONE == Mock.AdModel_DoNothingExceptTestPointers_CallInstance, cmock_line, CMockStringCalledLess);
  if (Mock.AdcModel_DoNothingExceptReturnASpecialType_IgnoreBool)
    Mock.AdcModel_DoNothingExceptReturnASpecialType_CallInstance = CMOCK_GUTS_NONE;
  UNITY_SET_DETAIL(CMockString_AdcModel_DoNothingExceptReturnASpecialType);
  UNITY_TEST_ASSERT(CMOCK_GUTS_NONE == Mock.AdcModel_DoNothingExceptReturnASpecialType_CallInstance, cmock_line, CMockStringCalledLess);
}
...
void AdcModel_DoGetSample_CMockIgnoreAndReturn(UNITY_LINE_TYPE cmock_line, bool cmock_to_return)
{
  ...
  Mock.AdcModel_DoGetSample_IgnoreBool = (int)0;
  cmock_call_instance->LineNumber = cmock_line;
  cmock_call_instance->ReturnVal = cmock_to_return;
  Mock.AdcModel_DoGetSample_IgnoreBool = (int)1;
}
...
{
  Mock.AdcModel_ProcessInput_IgnoreBool = (int)1;
}
...
void AdcModel_ProcessInput_CMockExpect(UNITY_LINE_TYPE cmock_line, uint16 millivolts)
{
  ...
  Mock.AdcModel_ProcessInput_IgnoreBool = (int)0;
  cmock_call_instance->LineNumber = cmock_line;
  cmock_call_instance->CallOrder = ++GlobalExpectCount;
...
void AdcModel_DoNothingExceptTestASpecialType_CMockIgnoreAndReturn(UNITY_LINE_TYPE cmock_line, bool cmock_to_return)
{
  ...
  Mock.AdcModel_DoNothingExceptTestASpecialType_IgnoreBool = (int)0;
  cmock_call_instance->LineNumber = cmock_line;
  cmock_call_instance->ReturnVal = cmock_to_return;
  Mock.AdcModel_DoNothingExceptTestASpecialType_IgnoreBool = (int)1;
}
...
void AdModel_DoNothingExceptTestPointers_CMockIgnoreAndReturn(UNITY_LINE_TYPE cmock_line, bool cmock_to_return)
{
  ...
  Mock.AdModel_DoNothingExceptTestPointers_IgnoreBool = (int)0;
  cmock_call_instance->LineNumber = cmock_line;
  cmock_call_instance->ReturnVal = cmock_to_return;
  Mock.AdModel_DoNothingExceptTestPointers_IgnoreBool = (int)1;
}
...
EXAMPLE_STRUCT_T AdcModel_DoNothingExceptReturnASpecialType(void)
{
  ...
  if (Mock.AdcModel_DoNothingExceptReturnASpecialType_IgnoreBool)
  {
    ...
    memcpy(&Mock.AdcModel_DoNothingExceptReturnASpecialType_FinalReturn, &cmock_call_instance->ReturnVal, sizeof(EXAMPLE_STRUCT_T));
    return cmock_call_instance->ReturnVal;
  }
  UNITY_TEST_ASSERT_NOT_NULL(cmock_call_instance, cmock_line, CMockStringCalledMore);
  cmock_line = cmock_call_instance->LineNumber;
...
void AdcModel_DoNothingExceptReturnASpecialType_CMockIgnoreAndReturn(UNITY_LINE_TYPE cmock_line, EXAMPLE_STRUCT_T cmock_to_return)
{
  ...
  Mock.AdcModel_DoNothingExceptReturnASpecialType_IgnoreBool = (int)0;
  cmock_call_instance->LineNumber = cmock_line;
  cmock_call_instance->ReturnVal = cmock_to_return;
  Mock.AdcModel_DoNothingExceptReturnASpecialType_IgnoreBool = (int)1;
}
