...
void MockTaskScheduler_Verify(void)
{
  ...
  if (Mock.TaskScheduler_Init_IgnoreBool)
    Mock.TaskScheduler_Init_CallInstance = CMOCK_GUTS_NONE;
  UNITY_SET_DETAIL(CMockString_TaskScheduler_Init);
  UNITY_TEST_ASSERT(CMOCK_GUTS_NONE == Mock.TaskScheduler_Init_CallInstance, cmock_line, CMockStringCalledLess);
  if (Mock.TaskScheduler_Update_IgnoreBool)
    Mock.TaskScheduler_Update_CallInstance = CMOCK_GUTS_NONE;
  UNITY_SET_DETAIL(CMockString_TaskScheduler_Update);
  UNITY_TEST_ASSERT(CMOCK_GUTS_NONE == Mock.TaskScheduler_Update_CallInstance, cmock_line, CMockStringCalledLess);
  if (Mock.TaskScheduler_DoUsart_IgnoreBool)
    Mock.TaskScheduler_DoUsart_CallInstance = CMOCK_GUTS_NONE;
  UNITY_SET_DETAIL(CMockString_TaskScheduler_DoUsart);
  UNITY_TEST_ASSERT(CMOCK_GUTS_NONE == Mock.TaskScheduler_DoUsart_CallInstance, cmock_line, CMockStringCalledLess);
  if (Mock.TaskScheduler_DoAdc_IgnoreBool)
    Mock.TaskScheduler_DoAdc_CallInstance = CMOCK_GUTS_NONE;
  UNITY_SET_DETAIL(CMockString_TaskScheduler_DoAdc);
  UNITY_TEST_ASSERT(CMOCK_GUTS_NONE == Mock.TaskScheduler_DoAdc_CallInstance, cmock_line, CMockStringCalledLess);
}
...
{
  Mock.TaskScheduler_Init_IgnoreBool = (int)1;
}
...
void TaskScheduler_Init_CMockExpect(UNITY_LINE_TYPE cmock_line)
{
  ...
  Mock.TaskScheduler_Init_IgnoreBool = (int)0;
...
{
  Mock.TaskScheduler_Update_IgnoreBool = (int)1;
}
...
void TaskScheduler_Update_CMockExpect(UNITY_LINE_TYPE cmock_line, uint32 time)
{
  ...
  Mock.TaskScheduler_Update_IgnoreBool = (int)0;
  cmock_call_instance->LineNumber = cmock_line;
  cmock_call_instance->CallOrder = ++GlobalExpectCount;
...
void TaskScheduler_DoUsart_CMockIgnoreAndReturn(UNITY_LINE_TYPE cmock_line, bool cmock_to_return)
{
  ...
  Mock.TaskScheduler_DoUsart_IgnoreBool = (int)0;
  cmock_call_instance->LineNumber = cmock_line;
  cmock_call_instance->ReturnVal = cmock_to_return;
  Mock.TaskScheduler_DoUsart_IgnoreBool = (int)1;
}
...
void TaskScheduler_DoAdc_CMockIgnoreAndReturn(UNITY_LINE_TYPE cmock_line, bool cmock_to_return)
{
  ...
  Mock.TaskScheduler_DoAdc_IgnoreBool = (int)0;
  cmock_call_instance->LineNumber = cmock_line;
  cmock_call_instance->ReturnVal = cmock_to_return;
  Mock.TaskScheduler_DoAdc_IgnoreBool = (int)1;
}
