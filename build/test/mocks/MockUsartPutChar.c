...
void MockUsartPutChar_Verify(void)
{
  ...
  if (Mock.Usart_PutChar_IgnoreBool)
    Mock.Usart_PutChar_CallInstance = CMOCK_GUTS_NONE;
  UNITY_SET_DETAIL(CMockString_Usart_PutChar);
  UNITY_TEST_ASSERT(CMOCK_GUTS_NONE == Mock.Usart_PutChar_CallInstance, cmock_line, CMockStringCalledLess);
}
...
{
  Mock.Usart_PutChar_IgnoreBool = (int)1;
}
...
void Usart_PutChar_CMockExpect(UNITY_LINE_TYPE cmock_line, char data)
{
  ...
  Mock.Usart_PutChar_IgnoreBool = (int)0;
