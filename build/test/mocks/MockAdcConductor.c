...
void MockAdcConductor_Verify(void)
{
  ...
  if (Mock.AdcConductor_Init_IgnoreBool)
    Mock.AdcConductor_Init_CallInstance = CMOCK_GUTS_NONE;
  UNITY_SET_DETAIL(CMockString_AdcConductor_Init);
  UNITY_TEST_ASSERT(CMOCK_GUTS_NONE == Mock.AdcConductor_Init_CallInstance, cmock_line, CMockStringCalledLess);
  if (Mock.AdcConductor_Run_IgnoreBool)
    Mock.AdcConductor_Run_CallInstance = CMOCK_GUTS_NONE;
  UNITY_SET_DETAIL(CMockString_AdcConductor_Run);
  UNITY_TEST_ASSERT(CMOCK_GUTS_NONE == Mock.AdcConductor_Run_CallInstance, cmock_line, CMockStringCalledLess);
  if (Mock.AdcConductor_JustHereToTest_IgnoreBool)
    Mock.AdcConductor_JustHereToTest_CallInstance = CMOCK_GUTS_NONE;
  UNITY_SET_DETAIL(CMockString_AdcConductor_JustHereToTest);
  UNITY_TEST_ASSERT(CMOCK_GUTS_NONE == Mock.AdcConductor_JustHereToTest_CallInstance, cmock_line, CMockStringCalledLess);
  if (Mock.AdcConductor_AlsoHereToTest_IgnoreBool)
    Mock.AdcConductor_AlsoHereToTest_CallInstance = CMOCK_GUTS_NONE;
  UNITY_SET_DETAIL(CMockString_AdcConductor_AlsoHereToTest);
  UNITY_TEST_ASSERT(CMOCK_GUTS_NONE == Mock.AdcConductor_AlsoHereToTest_CallInstance, cmock_line, CMockStringCalledLess);
  if (Mock.AdcConductor_YetAnotherTest_IgnoreBool)
    Mock.AdcConductor_YetAnotherTest_CallInstance = CMOCK_GUTS_NONE;
  UNITY_SET_DETAIL(CMockString_AdcConductor_YetAnotherTest);
  UNITY_TEST_ASSERT(CMOCK_GUTS_NONE == Mock.AdcConductor_YetAnotherTest_CallInstance, cmock_line, CMockStringCalledLess);
}
...
{
  Mock.AdcConductor_Init_IgnoreBool = (int)1;
}
...
void AdcConductor_Init_CMockExpect(UNITY_LINE_TYPE cmock_line)
{
  ...
  Mock.AdcConductor_Init_IgnoreBool = (int)0;
...
{
  Mock.AdcConductor_Run_IgnoreBool = (int)1;
}
...
void AdcConductor_Run_CMockExpect(UNITY_LINE_TYPE cmock_line)
{
  ...
  Mock.AdcConductor_Run_IgnoreBool = (int)0;
  cmock_call_instance->LineNumber = cmock_line;
  cmock_call_instance->CallOrder = ++GlobalExpectCount;
  UNITY_CLR_DETAILS();
}
...
void AdcConductor_JustHereToTest_CMockIgnoreAndReturn(UNITY_LINE_TYPE cmock_line, bool cmock_to_return)
{
  ...
  Mock.AdcConductor_JustHereToTest_IgnoreBool = (int)0;
  cmock_call_instance->LineNumber = cmock_line;
  cmock_call_instance->ReturnVal = cmock_to_return;
  Mock.AdcConductor_JustHereToTest_IgnoreBool = (int)1;
}
...
void AdcConductor_AlsoHereToTest_CMockIgnoreAndReturn(UNITY_LINE_TYPE cmock_line, bool cmock_to_return)
{
  ...
  Mock.AdcConductor_AlsoHereToTest_IgnoreBool = (int)0;
  cmock_call_instance->LineNumber = cmock_line;
  cmock_call_instance->ReturnVal = cmock_to_return;
  Mock.AdcConductor_AlsoHereToTest_IgnoreBool = (int)1;
}
...
void AdcConductor_YetAnotherTest_CMockIgnoreAndReturn(UNITY_LINE_TYPE cmock_line, bool cmock_to_return)
{
  ...
  Mock.AdcConductor_YetAnotherTest_IgnoreBool = (int)0;
  cmock_call_instance->LineNumber = cmock_line;
  cmock_call_instance->ReturnVal = cmock_to_return;
  Mock.AdcConductor_YetAnotherTest_IgnoreBool = (int)1;
}
