...
{
  int UsartModel_GetBaudRateRegisterSetting_IgnoreBool;
...
void MockUsartModel_Verify(void)
{
  ...
  if (Mock.UsartModel_GetBaudRateRegisterSetting_IgnoreBool)
    Mock.UsartModel_GetBaudRateRegisterSetting_CallInstance = CMOCK_GUTS_NONE;
  UNITY_SET_DETAIL(CMockString_UsartModel_GetBaudRateRegisterSetting);
  UNITY_TEST_ASSERT(CMOCK_GUTS_NONE == Mock.UsartModel_GetBaudRateRegisterSetting_CallInstance, cmock_line, CMockStringCalledLess);
  if (Mock.UsartModel_GetFormattedTemperature_IgnoreBool)
    Mock.UsartModel_GetFormattedTemperature_CallInstance = CMOCK_GUTS_NONE;
  UNITY_SET_DETAIL(CMockString_UsartModel_GetFormattedTemperature);
  UNITY_TEST_ASSERT(CMOCK_GUTS_NONE == Mock.UsartModel_GetFormattedTemperature_CallInstance, cmock_line, CMockStringCalledLess);
  if (Mock.UsartModel_GetWakeupMessage_IgnoreBool)
    Mock.UsartModel_GetWakeupMessage_CallInstance = CMOCK_GUTS_NONE;
  UNITY_SET_DETAIL(CMockString_UsartModel_GetWakeupMessage);
  UNITY_TEST_ASSERT(CMOCK_GUTS_NONE == Mock.UsartModel_GetWakeupMessage_CallInstance, cmock_line, CMockStringCalledLess);
}
...
void UsartModel_GetBaudRateRegisterSetting_CMockIgnoreAndReturn(UNITY_LINE_TYPE cmock_line, uint8 cmock_to_return)
{
  ...
  Mock.UsartModel_GetBaudRateRegisterSetting_IgnoreBool = (int)0;
  cmock_call_instance->LineNumber = cmock_line;
  cmock_call_instance->ReturnVal = cmock_to_return;
  Mock.UsartModel_GetBaudRateRegisterSetting_IgnoreBool = (int)1;
}
...
void UsartModel_GetFormattedTemperature_CMockIgnoreAndReturn(UNITY_LINE_TYPE cmock_line, char* cmock_to_return)
{
  ...
  Mock.UsartModel_GetFormattedTemperature_IgnoreBool = (int)0;
  cmock_call_instance->LineNumber = cmock_line;
  cmock_call_instance->ReturnVal = cmock_to_return;
  Mock.UsartModel_GetFormattedTemperature_IgnoreBool = (int)1;
}
...
void UsartModel_GetWakeupMessage_CMockIgnoreAndReturn(UNITY_LINE_TYPE cmock_line, char* cmock_to_return)
{
  ...
  Mock.UsartModel_GetWakeupMessage_IgnoreBool = (int)0;
  cmock_call_instance->LineNumber = cmock_line;
  cmock_call_instance->ReturnVal = cmock_to_return;
  Mock.UsartModel_GetWakeupMessage_IgnoreBool = (int)1;
}
