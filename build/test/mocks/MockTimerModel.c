...
{
  int TimerModel_UpdateTime_IgnoreBool;
...
void MockTimerModel_Verify(void)
{
  ...
  if (Mock.TimerModel_UpdateTime_IgnoreBool)
    Mock.TimerModel_UpdateTime_CallInstance = CMOCK_GUTS_NONE;
  UNITY_SET_DETAIL(CMockString_TimerModel_UpdateTime);
  UNITY_TEST_ASSERT(CMOCK_GUTS_NONE == Mock.TimerModel_UpdateTime_CallInstance, cmock_line, CMockStringCalledLess);
}
...
{
  Mock.TimerModel_UpdateTime_IgnoreBool = (int)1;
}
...
void TimerModel_UpdateTime_CMockExpect(UNITY_LINE_TYPE cmock_line, uint32 systemTime)
{
  ...
  Mock.TimerModel_UpdateTime_IgnoreBool = (int)0;
